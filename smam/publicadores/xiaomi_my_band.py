...
class XiaomiMyBand:
    ...
    def publish(self):
        self.publish_body_temperature()
        time.sleep(1)
        self.publish_heart_rate()
        time.sleep(1)
        self.publish_blood_preasure()

    def publish_body_temperature(self):
        message = {}
    ...
    def publish_blood_preasure(self):
        message = {}
